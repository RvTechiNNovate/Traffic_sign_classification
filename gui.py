...
label=Label(top,background='green', font=('arial',15,'bold'))
...
def show_classify_button(file_path):
    ...
    classify_b.configure(background='blue', foreground='white',font=('arial',10,'bold'))
...
heading.configure(background='white',foreground='green')
heading.pack()
top.mainloop()
